...
export default function App() {
  return (
    <>
    <main className='px-6 py-24 xl:flex xl:flex-wrap xl:px-24 xl:h-screen 2xl:pl-36 background__main'>
    ...
    <footer className='text-center absolute bottom-0 text-sm'>
      Challenge by <a href="https://www.frontendmentor.io?ref=challenge" target="_blank" rel="noreferrer" className='text-veryDarkMagenta text-sm'>Frontend Mentor</a>. 
      Coded by <a href="https://github.com/R3ygoski" target='_blank' rel="noreferrer" className='text-veryDarkMagenta text-sm'>Bernardo Poggioni</a>.
    </footer>
    </>
  )
}
